...
- [ ] IQ-150 Implement HolyC `RoPEQ16RotateHeadRangeByTokenWindowPreflightedHeadBasesChecked` execution path in `src/model/rope.HC` with a precomputed head-base index buffer reused across all token iterations and strict checked capacity/overflow contracts (WS5-01)
