...
- [ ] IQ-169 Implement HolyC helper `FPQ16SoftmaxExpPhaseFromPreclampedChecked` in `src/math/softmax.HC` to compute exp-lanes from pre-clamped logits by composing `FPQ16ExpArrayFromClampedInputChecked` and checked sum accumulation for split-phase softmax pipelines (WS1-03)
