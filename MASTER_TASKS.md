...
- [ ] IQ-124 Implement HolyC helper `Q8_0MatMulTiledComputeRowBaseChecked` in `src/matmul/q8_0_matmul.HC` to centralize checked `row_index*{lhs_row_stride_blocks,out_row_stride_cells}` base math reused by scalar and AVX2 tiled loops (WS4-03)
- [ ] IQ-125 Implement HolyC helper `Q8_0MatMulTiledComputeOutIndexChecked` in `src/matmul/q8_0_matmul.HC` to centralize checked `out_row_base+col_index` index derivation and overflow handling across scalar/AVX2 tiled paths (WS4-03)
