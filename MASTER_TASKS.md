...
- [ ] IQ-151 Implement HolyC `FPQ16MulDivRoundedChecked` in `src/math/fixedpoint.HC` for checked `(a*b)/d` with one rounding step (overflow/domain-safe) to support RMSNorm and softmax scaling paths (WS1-01)
