...
- [ ] IQ-155 Implement HolyC `FPQ16RMSNormApplyInvDenomWeightedChecked` in `src/math/rmsnorm.HC` to compose checked inverse-denominator scaling with per-channel gamma multiply and explicit BAD_PARAM/OVERFLOW surfaces for WS5 transformer norm paths (WS1-04)
