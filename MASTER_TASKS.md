...
- [ ] IQ-157 Implement HolyC `FPQ16RMSNormApplyInvDenomWeightedAutoChecked` in `src/math/rmsnorm.HC` to dispatch between in-place and out-of-place weighted inverse-denominator paths based on pointer aliasing while preserving identical checked error surfaces (WS1-04)
