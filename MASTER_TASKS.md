...
- [ ] IQ-095 Implement HolyC `Q8_0DotRowsQ16MatrixVectorChecked` in `src/quant/q8_0_dot.HC` with explicit matrix/vector extent + row accumulator overflow guards and adversarial parity coverage in `tests/test_q8_0_dot.py` (WS4-02)
