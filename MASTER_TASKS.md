...
- [ ] IQ-152 Implement HolyC `FPQ16MulDivRoundedByPositiveIntChecked` in `src/math/fixedpoint.HC` for checked `(a*b)/d_int` fast path (`d_int>0`) with half-up rounding and overflow contracts for RMSNorm denominator specialization (WS1-01)
