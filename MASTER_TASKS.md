...
- [ ] IQ-170 Implement HolyC helper `FPQ16SoftmaxExpPhaseFromPreclampedNoAliasChecked` in `src/math/softmax.HC` to require disjoint input/output buffers while reusing shared checked span+sum logic for immutable-logit callers (WS1-03)
