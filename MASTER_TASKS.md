...
- [ ] IQ-158 Implement HolyC helper `FPQ16RMSNormApplyInvDenomWeightedAutoValidateChecked` in `src/math/rmsnorm.HC` to centralize null/len/denominator/gamma capacity checks shared by auto-dispatch RMSNorm entrypoints (WS1-04)
