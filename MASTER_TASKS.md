...
- [ ] IQ-156 Implement HolyC `FPQ16RMSNormApplyInvDenomWeightedInPlaceChecked` in `src/math/rmsnorm.HC` to support alias-safe in-place weighted norm writes (`input_q16 == output_q16`) with the same checked denominator and overflow contracts (WS1-04)
