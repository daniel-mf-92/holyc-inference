...
- [ ] IQ-154 Implement HolyC `FPQ16RMSNormApplyInvDenomChecked` in `src/math/rmsnorm.HC` to apply precomputed inverse denominator scaling via checked one-rounding mul/div helpers (Q16 denominator contract) and return explicit error codes for WS5 norm call chains (WS1-04)
