...
- [ ] IQ-122 Implement HolyC helper `Q8_0MatMulTiledValidateTileShapeChecked` in `src/matmul/q8_0_matmul.HC` to centralize `{tile_rows>0, tile_cols>0}` invariants for scalar and AVX2 tiled entrypoints (WS4-03)
