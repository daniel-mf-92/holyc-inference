...
- [ ] IQ-123 Implement HolyC helper `Q8_0MatMulTiledComputeTileEndChecked` in `src/matmul/q8_0_matmul.HC` to centralize checked `tile_end=min(tile_start+tile_span,axis_len)` math for row/col traversal loops across scalar and AVX2 tiled entrypoints (WS4-03)
