...
def test_error_paths_preserve_outputs() -> None:
    ...
    assert got_last_q == [901]
    assert got_last_k == [902]
    assert got_last_out == [903]
    assert got_req_q == [904]
    assert got_req_k == [905]
    assert got_req_out == [906]
    assert got_req_q_bytes == [907]
    assert got_req_k_bytes == [908]
    assert got_req_out_bytes == [909]
...
def test_overflow_passthrough_preserves_outputs() -> None:
    ...
    assert got_last_k == [12]
    assert got_last_out == [13]
    assert got_req_q == [14]
    assert got_req_k == [15]
    assert got_req_out == [16]
    assert got_req_q_bytes == [17]
    assert got_req_k_bytes == [18]
    assert got_req_out_bytes == [19]
