#!/usr/bin/env python3
"""Harness for IQ-1703 snapshot-digest preflight-parity commit-only wrapper."""
...
def fast_path_switch_secure_local_overhead_budget_cross_gate_snapshot_digest_q64_checked_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_iq1703(
    ...
    *,
    ...
    status_primary, _ = (
        _BASE_IQ1702_MOD.fast_path_switch_secure_local_overhead_budget_cross_gate_snapshot_digest_q64_checked_commit_only_preflight_only_parity_commit_only_preflight_only_parity_iq1702(
    ...
    _, staged_enabled, staged_reason, staged_digest_q64 = (
        _BASE_IQ1690_MOD._BASE_IQ1689_MOD.fast_path_switch_secure_local_overhead_budget_cross_gate_snapshot_digest_q64_checked_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_iq1689(
            secure_local_mode=secure_local_mode,
            iommu_active=iommu_active,
            book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
            policy_digest_parity=policy_digest_parity,
...
def test_source_contains_iq1703_symbols() -> None:
    ...
    assert "// IQ-1703 commit-only hardening wrapper:" in src


def test_gate_missing_vector() -> None:
    status, enabled, reason, digest_q64 = (
        fast_path_switch_secure_local_overhead_budget_cross_gate_snapshot_digest_q64_checked_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_iq1703(
...
if __name__ == "__main__":
    test_source_contains_iq1703_symbols()
