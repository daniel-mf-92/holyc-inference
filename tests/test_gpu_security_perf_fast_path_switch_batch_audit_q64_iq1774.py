#!/usr/bin/env python3
"""Harness for IQ-1774 fast-path batch audit strict diagnostics parity gate."""
...
import test_gpu_security_perf_fast_path_switch_batch_audit_q64_iq1773 as iq1773

GPU_SEC_PERF_OK = iq1772.GPU_SEC_PERF_OK
GPU_SEC_PERF_ERR_BAD_PARAM = iq1772.GPU_SEC_PERF_ERR_BAD_PARAM
GPU_SEC_PERF_PROFILE_SECURE_LOCAL = iq1772.GPU_SEC_PERF_PROFILE_SECURE_LOCAL

Scenario = iq1772.Scenario

HC_FN_IQ1774 = "GPUSecurityPerfFastPathSwitchBatchAuditQ64CheckedCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParity"
HC_FN_PRIMARY = iq1773.HC_FN_IQ1773
HC_FN_CANONICAL = iq1772.HC_FN_IQ1772
...
def iq1774_model(
    ...
    *,
    ...
    status_canonical, canonical_tuple = iq1772.iq1772_model(
        scenarios=scenarios,
    ...
    status_primary, staged_tuple = iq1773.iq1773_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
...
def test_source_contains_iq1774_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert f"I32 {HC_FN_IQ1774}(" in src
    ...
    assert "// IQ-1774 strict diagnostics parity gate:" in src


def test_gate_missing_vector() -> None:
    saved_out = (2701, 2702, 2703, 2704)
    status, out_values = iq1774_model(
...
if __name__ == "__main__":
    test_source_contains_iq1774_symbols()
