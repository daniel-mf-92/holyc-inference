#!/usr/bin/env python3
"""Reference checks for GQAAttentionApplySoftmaxQ16CheckedNoPartialCommitOnlyPreflightOnlyParity (IQ-1379)."""
...
def gqa_attention_apply_softmax_q16_checked_nopartial_commit_only_preflight_only_parity(
    scores_q32,
    scores_capacity: int,
    query_rows: int,
    key_rows: int,
...
def test_randomized_parity_publish_path() -> None:
    rng = random.Random(20260425_1379)
...
def test_source_contract_markers() -> None:
    ...
    assert "I32 GQAAttentionApplySoftmaxQ16CheckedNoPartialCommitOnlyPreflightOnlyParity(" in source
    body = source.split(
        "I32 GQAAttentionApplySoftmaxQ16CheckedNoPartialCommitOnlyPreflightOnlyParity(", 1
    )[1]
...
if __name__ == "__main__":
    ...
    print(
        "gqa_attention_apply_softmax_q16_checked_nopartial_commit_only_preflight_only_parity_reference_checks=ok"
    )
