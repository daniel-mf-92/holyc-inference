#!/usr/bin/env python3
"""Reference checks for ...PreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnly (IQ-1391)."""
...
from test_attention_gqa_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity import (
    gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity,
)
from test_attention_gqa_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only import (
    gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only,
)

I64_MAX = (1 << 63) - 1


def gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only(
    q_rows_q16,
    q_rows_capacity: int,
    q_rows: int,
    k_rows_q16,
    ...
    err = gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity(
        q_rows_q16,
        q_rows_capacity,
        q_rows,
        k_rows_q16,
...
def test_fixed_vector_reference_publishes_required_tuple_without_touching_scores() -> None:
    ...
    err = gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only(
        q,
        len(q),
        q_rows,
        k,
...
def test_randomized_parity_success() -> None:
    rng = random.Random(20260425_1391)
...
def test_source_contract_markers() -> None:
    ...
    sig = "I32 GQAAttentionScoreQ16CheckedNoPartialCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnly("
    assert sig in source
    body = source.split(sig, 1)[1]

    assert "status = GQAAttentionScoreQ16CheckedNoPartialCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParity(" in body
    assert "status = GQAAttentionScoreQ16CheckedNoPartialCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnly(" in body
...
if __name__ == "__main__":
    ...
    print(
        "gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_reference_checks=ok"
    )
