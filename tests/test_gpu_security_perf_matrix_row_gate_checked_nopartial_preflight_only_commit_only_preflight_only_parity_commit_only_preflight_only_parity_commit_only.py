#!/usr/bin/env python3
"""Harness for IQ-1528 commit-only row-gate wrapper over strict parity + preflight diagnostics."""
...
def test_source_contains_iq1528_symbols() -> None:
...
if __name__ == "__main__":
    test_source_contains_iq1528_symbols()
