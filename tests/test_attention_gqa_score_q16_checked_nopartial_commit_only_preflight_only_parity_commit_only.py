#!/usr/bin/env python3
"""Reference checks for GQAAttentionScoreQ16CheckedNoPartialCommitOnlyPreflightOnlyParityCommitOnly (IQ-1376)."""
...
def gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only(
    q_rows_q16,
    q_rows_capacity: int,
    q_rows: int,
    k_rows_q16,
...
def test_randomized_parity_success() -> None:
    rng = random.Random(20260425_1376)
...
def test_source_contract_markers() -> None:
    ...
    sig = "I32 GQAAttentionScoreQ16CheckedNoPartialCommitOnlyPreflightOnlyParityCommitOnly("
...
if __name__ == "__main__":
    ...
    print("gqa_attention_score_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_reference_checks=ok")
