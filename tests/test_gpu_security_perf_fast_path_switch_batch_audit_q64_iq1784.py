...
import test_gpu_security_perf_fast_path_switch_batch_audit_q64_iq1783 as iq1783

GPU_SEC_PERF_OK = iq1783.GPU_SEC_PERF_OK
GPU_SEC_PERF_ERR_BAD_PARAM = iq1783.GPU_SEC_PERF_ERR_BAD_PARAM
GPU_SEC_PERF_PROFILE_SECURE_LOCAL = iq1783.GPU_SEC_PERF_PROFILE_SECURE_LOCAL

Scenario = iq1783.Scenario
...
HC_FN_PARITY = iq1783.HC_FN_IQ1783
...
def iq1784_model(
    ...
    *,
    ...
    status_seed, staged_tuple = iq1783.iq1783_model(
        scenarios=scenarios,
        ...
        initial_out=(0, 0, 0, 0),
        force_digest_drift_companion=force_digest_drift_seed,
        force_status_domain_drift_companion=force_status_domain_drift_seed,
    )
    ...
    status_parity, parity_tuple = iq1783.iq1783_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
