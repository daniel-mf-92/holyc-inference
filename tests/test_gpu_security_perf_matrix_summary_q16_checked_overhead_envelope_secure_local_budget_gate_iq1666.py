#!/usr/bin/env python3
"""Harness for IQ-1666 zero-write diagnostics companion over IQ-1663 + IQ-1662 canonical parity."""
...
def test_source_contains_iq1666_symbols() -> None:
    ...
    assert "// IQ-1666 zero-write diagnostics companion over IQ-1663 commit-only hardening + IQ-1662 canonical parity gate:" in src
...
def test_gate_missing_and_threshold_breach_vectors() -> None:
    ...
    status, outputs = secure_local_budget_gate_iq1666(
        rows_gate_missing,
        rows_capacity=3,
...
if __name__ == "__main__":
    test_source_contains_iq1666_symbols()
