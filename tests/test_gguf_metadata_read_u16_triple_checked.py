#!/usr/bin/env python3
"""Reference checks for GGUFMetadataReadU16TripleChecked semantics."""
...
def test_null_ptr_and_no_partial_write() -> None:
    ...
    assert (
        gguf_metadata_read_u16_triple_checked(
            None,
            10,
            cursor,
            10,
...
def test_randomized_parity() -> None:
    rng = random.Random(20260417_236)
...
def run() -> None:
    ...
    print("gguf_metadata_read_u16_triple_checked_reference_checks=ok")
