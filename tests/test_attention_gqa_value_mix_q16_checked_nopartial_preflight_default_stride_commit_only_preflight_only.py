...
def gqa_attention_value_mix_q16_checked_nopartial_preflight_default_stride_commit_only_preflight_only(
    scores_q16,
    scores_capacity: int,
    query_rows: int,
    key_rows: int,
...
if __name__ == "__main__":
    ...
    print(
        "gqa_attention_value_mix_q16_checked_nopartial_preflight_default_stride_commit_only_preflight_only_reference_checks=ok"
    )
