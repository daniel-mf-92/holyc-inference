...
def tensor_range_find_by_index(
    tensor_index: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
    sorted_position_by_tensor: list[int],
):
    return tensor_index_to_abs_range(
...
def tensor_lookup_by_rel_offset(
    tensor_rel_offset: int,
    tensor_data_base: int,
    alignment: int,
    tensor_abs_starts: list[int],
    ...
    err, sorted_pos = tensor_range_find_by_rel_offset(
        tensor_rel_offset=tensor_rel_offset,
        tensor_data_base=tensor_data_base,
        alignment=alignment,
        tensor_abs_starts=tensor_abs_starts,
...
def tensor_lookup_by_rel_offset_default(
    tensor_rel_offset: int,
    tensor_data_base: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
    ...
    return tensor_lookup_by_rel_offset(
        tensor_rel_offset=tensor_rel_offset,
        tensor_data_base=tensor_data_base,
        alignment=GGUF_DEFAULT_ALIGNMENT,
        tensor_abs_starts=tensor_abs_starts,
...
def tensor_lookup_by_abs_offset_default(
    abs_offset: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
    sorted_tensor_indices: list[int],
):
    return tensor_lookup_by_abs_offset(
        abs_offset=abs_offset,
        tensor_abs_starts=tensor_abs_starts,
        tensor_abs_ends=tensor_abs_ends,
        sorted_tensor_indices=sorted_tensor_indices,
...
def tensor_lookup_by_abs_offset_with_inner_offset(
    abs_offset: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
    sorted_tensor_indices: list[int],
...
def tensor_lookup_by_rel_offset_with_inner_offset(
    tensor_rel_offset: int,
    tensor_data_base: int,
    alignment: int,
    tensor_abs_starts: list[int],
    ...
    err, tensor_index, abs_start, abs_end = tensor_lookup_by_rel_offset(
        tensor_rel_offset=tensor_rel_offset,
        tensor_data_base=tensor_data_base,
        alignment=alignment,
        tensor_abs_starts=tensor_abs_starts,
    ...
    if abs_offset < abs_start or abs_offset >= abs_end:
...
def tensor_lookup_by_index_with_inner_offset(
    tensor_index: int,
    abs_offset: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
...
def tensor_lookup_span_by_abs_range(
    span_abs_start: int,
    span_abs_end: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
    ...
    if span_abs_end < span_abs_start:
        return GGUF_TDBASE_ERR_OVERFLOW, 0, 0, 0, 0, 0

    err, tensor_index, tensor_abs_start, tensor_abs_end = tensor_lookup_by_abs_offset(
        span_abs_start,
        tensor_abs_starts,
        tensor_abs_ends,
    ...
    if span_abs_end > tensor_abs_end:
        return GGUF_TDBASE_ERR_OUT_OF_BOUNDS, 0, 0, 0, 0, 0
...
def tensor_lookup_span_by_rel_range(
    span_rel_start: int,
    span_rel_end: int,
    tensor_data_base: int,
    alignment: int,
    ...
    return tensor_lookup_span_by_abs_range(
        span_abs_start,
        span_abs_end,
        tensor_abs_starts,
        tensor_abs_ends,
...
def tensor_lookup_span_by_index_and_abs_range(
    ...
    err, tensor_abs_start, tensor_abs_end = tensor_range_find_by_index(
        tensor_index=tensor_index,
        tensor_abs_starts=tensor_abs_starts,
        tensor_abs_ends=tensor_abs_ends,
        sorted_position_by_tensor=sorted_position_by_tensor,
...
def tensor_lookup_span_by_index_and_rel_range_default(
    tensor_index: int,
    span_rel_start: int,
    span_rel_end: int,
    tensor_data_base: int,
    ...
    return tensor_lookup_span_by_index_and_rel_range(
        tensor_index=tensor_index,
        span_rel_start=span_rel_start,
        span_rel_end=span_rel_end,
        tensor_data_base=tensor_data_base,
        alignment=GGUF_DEFAULT_ALIGNMENT,
        tensor_abs_starts=tensor_abs_starts,
        tensor_abs_ends=tensor_abs_ends,
...
def tensor_info_load_payload_window_by_index_rel_default(
    tensor_index: int,
    payload_rel_start: int,
    payload_rel_end: int,
    tensor_data_base: int,
    tensor_abs_starts: list[int],
    tensor_abs_ends: list[int],
    ...
    if tensor_data_base % GGUF_DEFAULT_ALIGNMENT != 0:
    ...
    err, tensor_abs_start, _tensor_abs_end, span_start, span_end = tensor_lookup_span_by_index_and_abs_range(
        tensor_index=tensor_index,
        span_abs_start=abs_start,
        span_abs_end=abs_end,
        tensor_abs_starts=tensor_abs_starts,
        tensor_abs_ends=tensor_abs_ends,
        sorted_position_by_tensor=sorted_position_by_tensor,
    )
...
def tensor_info_load_payload_window_by_index_rel(
    tensor_index: int,
    payload_rel_start: int,
    payload_rel_end: int,
    tensor_data_base: int,
    ...
    if err != GGUF_TDBASE_OK:
        return err, 0, 0, 0, 0
    if tensor_data_base % alignment != 0:
        return GGUF_TDBASE_ERR_MISALIGNED_BASE, 0, 0, 0, 0
    if payload_rel_end < payload_rel_start:
        return GGUF_TDBASE_ERR_OVERFLOW, 0, 0, 0, 0
    if tensor_data_base > U64_MAX - payload_rel_start:
    ...
    return tensor_info_load_payload_window_by_index_abs(
        tensor_index=tensor_index,
        payload_abs_start=abs_start,
        payload_abs_end=abs_end,
        tensor_abs_starts=tensor_abs_starts,
        tensor_abs_ends=tensor_abs_ends,
        sorted_position_by_tensor=sorted_position_by_tensor,
    )
...
def tensor_info_load_payload_window_by_rel_span(
    payload_rel_start: int,
    payload_rel_end: int,
    tensor_data_base: int,
    alignment: int,
    ...
    if err != GGUF_TDBASE_OK:
        return err, 0, 0, 0, 0, 0
    if tensor_data_base % alignment != 0:
        return GGUF_TDBASE_ERR_MISALIGNED_BASE, 0, 0, 0, 0, 0
    if payload_rel_end < payload_rel_start:
        return GGUF_TDBASE_ERR_OVERFLOW, 0, 0, 0, 0, 0
    if tensor_data_base > U64_MAX - payload_rel_start:
        return GGUF_TDBASE_ERR_OVERFLOW, 0, 0, 0, 0, 0
    ...
    payload_abs_start = tensor_data_base + payload_rel_start
    payload_abs_end = tensor_data_base + payload_rel_end

    err, tensor_index, tensor_abs_start, _tensor_abs_end, span_start, span_end = tensor_lookup_span_by_abs_range(
        span_abs_start=payload_abs_start,
        span_abs_end=payload_abs_end,
        tensor_abs_starts=tensor_abs_starts,
        tensor_abs_ends=tensor_abs_ends,
...
def tensor_info_build_lookup_tables_staged(
    tensor_data_base: int,
    alignment: int,
    gguf_file_nbytes: int,
    tensor_rel_offsets: list[int],
    ...
    out_sorted_tensor_indices: list[int],
    out_sorted_position_by_tensor: list[int],
    mutate_sorted_tensor_indices=None,
):
    """
    Host-side staged mirror for adversarial testing of
    GGUFTensorInfoBuildLookupTables phase boundaries.
    """
    err, bad = tensor_info_build_offset_index(
        tensor_data_base=tensor_data_base,
        alignment=alignment,
    ...
    if mutate_sorted_tensor_indices is not None:
        mutate_sorted_tensor_indices(out_sorted_tensor_indices)
...
def test_tensor_info_build_lookup_tables_staged_rejects_malformed_permutation() -> None:
    rel_offsets = [0x00, 0x80, 0x140, 0x1C0]
    element_counts = [32, 64, 32, 32]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    ...
    def corrupt_with_duplicate_permutation(indices: list[int]) -> None:
        indices[2] = indices[1]

    err, bad = tensor_info_build_lookup_tables_staged(
        tensor_data_base=0x2400,
        alignment=32,
        gguf_file_nbytes=0x20000,
        tensor_rel_offsets=rel_offsets,
        tensor_element_counts=element_counts,
        tensor_ggml_types=ggml_types,
        out_abs_starts=starts,
        ...
        out_sorted_tensor_indices=sorted_idx,
        out_sorted_position_by_tensor=inverse_map,
        mutate_sorted_tensor_indices=corrupt_with_duplicate_permutation,
    )
...
def test_tensor_info_build_lookup_tables_adversarial_overlap_matrix() -> None:
    rng = random.Random(0xC0FFEE66)
    ...
    for _ in range(120):
        ...
        for _i in range(count):
            ggml_type = rng.choice([GGML_TYPE_Q4_0, GGML_TYPE_Q8_0, GGML_TYPE_F16, GGML_TYPE_F32])
            if ggml_type in (GGML_TYPE_Q4_0, GGML_TYPE_Q8_0):
                elements = rng.randint(1, 6) * 32
            else:
                elements = rng.randint(8, 256)
            ...
            cursor += ((nbytes + 31) // 32) * 32 + rng.randrange(0, 4) * 32

        victim = rng.randint(1, count - 1)
        rel_offsets[victim] = rel_offsets[victim - 1]
...
def test_tensor_range_find_by_index_matches_tensor_index_to_abs_range() -> None:
    starts = [0x1200, 0x1400, 0x1500, 0x1700]
    ends = [0x1280, 0x1480, 0x1680, 0x17C0]
    sorted_idx = [2, 0, 3, 1]
    inverse_map = [0, 0, 0, 0]
    ...
    for tensor_index in range(4):
        err_a, start_a, end_a = tensor_index_to_abs_range(
            tensor_index,
            starts,
            ends,
            inverse_map,
        )
        err_b, start_b, end_b = tensor_range_find_by_index(
            tensor_index,
            starts,
            ends,
            inverse_map,
...
def test_tensor_range_find_by_index_propagates_bounds_error() -> None:
    starts = [0x1000, 0x1100, 0x1300]
    ends = [0x1080, 0x1180, 0x1380]
    inverse_map = [1, 2, 0]

    err, abs_start, abs_end = tensor_range_find_by_index(3, starts, ends, inverse_map)
    assert err == GGUF_TDBASE_ERR_OUT_OF_BOUNDS
    assert abs_start == 0
    assert abs_end == 0


def test_tensor_range_find_by_index_with_built_offset_index() -> None:
    rel_offsets = [0xC0, 0x00, 0x40, 0x100]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        err, abs_start, abs_end = tensor_range_find_by_index(
            original_idx,
            starts,
            ends,
            inverse_map,
        ...
        assert err == GGUF_TDBASE_OK
        assert abs_start == 0x1000 + rel_offsets[original_idx]
...
def test_tensor_lookup_by_rel_offset_happy_path() -> None:
    starts = [0x1000, 0x1040, 0x10C0]
    ends = [0x1020, 0x1080, 0x1100]
    sorted_idx = [2, 0, 1]

    assert tensor_lookup_by_rel_offset(0x00, 0x1000, 32, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        2,
        0x1000,
        0x1020,
    )
    assert tensor_lookup_by_rel_offset(0x40, 0x1000, 32, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        0,
        0x1040,
        0x1080,
    )
    assert tensor_lookup_by_rel_offset(0xC0, 0x1000, 32, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        1,
        0x10C0,
        0x1100,
...
def test_tensor_lookup_by_rel_offset_default_happy_path() -> None:
    starts = [0x2000, 0x2040]
    ends = [0x2020, 0x2060]
    sorted_idx = [1, 0]

    assert tensor_lookup_by_rel_offset_default(0x00, 0x2000, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        1,
        0x2000,
        0x2020,
    )
    assert tensor_lookup_by_rel_offset_default(0x40, 0x2000, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        0,
        0x2040,
        0x2060,
...
def test_tensor_lookup_by_rel_offset_propagates_alignment_error() -> None:
    starts = [0x1000]
    ends = [0x1020]
    sorted_idx = [0]
...
def test_tensor_lookup_by_rel_offset_propagates_miss() -> None:
    starts = [0x1000, 0x1080]
    ends = [0x1020, 0x10A0]
    sorted_idx = [0, 1]
...
def test_tensor_lookup_by_rel_offset_rejects_sorted_index_out_of_bounds() -> None:
    starts = [0x1000, 0x1040]
    ends = [0x1020, 0x1060]
    sorted_idx = [0, 9]
...
def test_tensor_lookup_by_rel_offset_rejects_bad_end_before_start() -> None:
    starts = [0x1000]
    ends = [0x0FFF]
    sorted_idx = [0]
...
def test_tensor_lookup_by_rel_offset_with_built_offset_index() -> None:
    rel_offsets = [0xC0, 0x00, 0x40, 0x100]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        err, tensor_index, abs_start, abs_end = tensor_lookup_by_rel_offset(
            tensor_rel_offset=rel_offsets[original_idx],
            tensor_data_base=0x1000,
            alignment=32,
...
def test_tensor_lookup_by_abs_offset_default_happy_path() -> None:
    starts = [0x3000, 0x3040, 0x3080]
    ends = [0x3020, 0x3060, 0x30A0]
    sorted_idx = [1, 2, 0]

    assert tensor_lookup_by_abs_offset_default(0x3005, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        1,
        0x3000,
        0x3020,
    )
    assert tensor_lookup_by_abs_offset_default(0x304F, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        2,
        0x3040,
        0x3060,
    )
    assert tensor_lookup_by_abs_offset_default(0x309E, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        0,
        0x3080,
        0x30A0,
...
def test_tensor_lookup_by_abs_offset_default_with_built_offset_index() -> None:
    rel_offsets = [0xA0, 0x00, 0x40]
    elem_counts = [32, 64, 32]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16]
    starts = [0, 0, 0]
    ends = [0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        abs_start = 0x2000 + rel_offsets[original_idx]
        err, tensor_index, out_start, out_end = tensor_lookup_by_abs_offset_default(
            abs_start,
            starts,
            ends,
            sorted_idx,
...
def test_tensor_lookup_by_index_with_inner_offset_happy_path() -> None:
    starts = [0x1200, 0x1400, 0x1500, 0x1700]
    ends = [0x1280, 0x1480, 0x1680, 0x17C0]
    sorted_idx = [2, 0, 3, 1]
    inverse_map = [0, 0, 0, 0]
    ...
    assert tensor_lookup_by_index_with_inner_offset(0, 0x1400, starts, ends, inverse_map) == (
        GGUF_TDBASE_OK,
        0x1400,
        0x1480,
        0,
    )
    assert tensor_lookup_by_index_with_inner_offset(1, 0x17BF, starts, ends, inverse_map) == (
        GGUF_TDBASE_OK,
        0x1700,
        0x17C0,
        0xBF,
    )
    assert tensor_lookup_by_index_with_inner_offset(2, 0x1250, starts, ends, inverse_map) == (
        GGUF_TDBASE_OK,
        0x1200,
        0x1280,
        0x50,
...
def test_tensor_lookup_by_index_with_inner_offset_propagates_errors() -> None:
    ...
    assert tensor_lookup_by_index_with_inner_offset(2, 0x1000, starts, ends, inverse_map) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
    )
    assert tensor_lookup_by_index_with_inner_offset(1, 0x1100, starts, ends, inverse_map) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
    )
    assert tensor_lookup_by_index_with_inner_offset(0, 0x117F, starts, ends, inverse_map) == (
        GGUF_TDBASE_OK,
        0x1100,
        0x1180,
        0x7F,
...
def test_tensor_lookup_by_index_with_inner_offset_with_built_offset_index() -> None:
    ...
    for original_idx in range(len(rel_offsets)):
        abs_start = 0x7000 + rel_offsets[original_idx]
        err_n, nbytes = tensor_bytes_for_type(ggml_types[original_idx], elem_counts[original_idx])
        assert err_n == GGUF_TDBASE_OK

        err, out_start, out_end, inner = tensor_lookup_by_index_with_inner_offset(
            original_idx,
            abs_start,
            starts,
            ends,
...
def test_tensor_lookup_by_abs_offset_with_inner_offset_happy_path() -> None:
    starts = [0x1000, 0x1080, 0x1100]
    ends = [0x1020, 0x10B0, 0x1160]
    sorted_idx = [2, 0, 1]

    assert tensor_lookup_by_abs_offset_with_inner_offset(0x1000, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        2,
        0x1000,
        0x1020,
    ...
    assert tensor_lookup_by_abs_offset_with_inner_offset(0x1095, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        0,
        0x1080,
        0x10B0,
    ...
    assert tensor_lookup_by_abs_offset_with_inner_offset(0x115F, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        1,
        0x1100,
        0x1160,
...
def test_tensor_lookup_by_abs_offset_with_inner_offset_propagates_errors() -> None:
    starts = [0x2000, 0x2100]
    ends = [0x2040, 0x2140]
    sorted_idx = [0, 1]

    assert tensor_lookup_by_abs_offset_with_inner_offset(0x2080, starts, ends, sorted_idx) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
...
def test_tensor_lookup_by_abs_offset_with_inner_offset_with_built_offset_index() -> None:
    rel_offsets = [0x280, 0x00, 0x2C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    err, bad = tensor_info_build_offset_index(
        tensor_data_base=0x5000,
        alignment=32,
        gguf_file_nbytes=0x9000,
        tensor_rel_offsets=rel_offsets,
        tensor_element_counts=elem_counts,
        tensor_ggml_types=ggml_types,
        out_abs_starts=starts,
    ...
    for original_idx in range(len(rel_offsets)):
        abs_start = 0x5000 + rel_offsets[original_idx]
        err, tensor_index, out_start, out_end, inner = tensor_lookup_by_abs_offset_with_inner_offset(
            abs_start,
            starts,
            ends,
            sorted_idx,
        ...
        if nbytes > 1:
            ...
            assert out_start == abs_start
            assert out_end == abs_start + nbytes
            assert inner == (mid - abs_start)


def test_tensor_lookup_by_rel_offset_with_inner_offset_happy_path() -> None:
    starts = [0x1000, 0x1080, 0x1100]
    ends = [0x1020, 0x10B0, 0x1160]
    sorted_idx = [2, 0, 1]

    assert tensor_lookup_by_rel_offset_with_inner_offset(0x00, 0x1000, 32, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        2,
        0x1000,
        0x1020,
    ...
    assert tensor_lookup_by_rel_offset_with_inner_offset(0x95, 0x1000, 1, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        0,
        0x1080,
        0x10B0,
    ...
    assert tensor_lookup_by_rel_offset_with_inner_offset(0x15F, 0x1000, 1, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        1,
        0x1100,
        0x1160,
...
def test_tensor_lookup_by_rel_offset_with_inner_offset_propagates_errors() -> None:
    starts = [0x2000, 0x2100]
    ends = [0x2040, 0x2140]
    sorted_idx = [0, 1]

    assert tensor_lookup_by_rel_offset_with_inner_offset(0x80, 0x2000, 32, starts, ends, sorted_idx) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
    ...
    assert tensor_lookup_by_rel_offset_with_inner_offset(0x48, 0x2000, 32, starts, ends, sorted_idx) == (
        GGUF_TDBASE_ERR_MISALIGNED_TENSOR_OFFSET,
        0,
        0,
        0,
...
def test_tensor_lookup_by_rel_offset_with_inner_offset_with_built_offset_index() -> None:
    rel_offsets = [0x280, 0x00, 0x2C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        rel_start = rel_offsets[original_idx]
        abs_start = 0x5000 + rel_start
        err, tensor_index, out_start, out_end, inner = tensor_lookup_by_rel_offset_with_inner_offset(
            rel_start,
            0x5000,
            32,
            starts,
        ...
        if nbytes > 1:
            # Use byte-granular alignment for inner-position probes inside payload.
...
def test_tensor_lookup_span_by_abs_range_happy_path() -> None:
    starts = [0x1000, 0x1080, 0x1100]
    ends = [0x1020, 0x10B0, 0x1160]
    sorted_idx = [2, 0, 1]

    assert tensor_lookup_span_by_abs_range(0x1000, 0x1000, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        2,
        0x1000,
        0x1020,
    ...
    assert tensor_lookup_span_by_abs_range(0x1090, 0x10A2, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        0,
        0x1080,
        0x10B0,
    ...
    assert tensor_lookup_span_by_abs_range(0x1120, 0x115F, starts, ends, sorted_idx) == (
        GGUF_TDBASE_OK,
        1,
        0x1100,
        0x1160,
...
def test_tensor_lookup_span_by_abs_range_propagates_errors() -> None:
    starts = [0x2000, 0x2100]
    ends = [0x2040, 0x2140]
    sorted_idx = [0, 1]

    assert tensor_lookup_span_by_abs_range(0x2030, 0x2020, starts, ends, sorted_idx) == (
        GGUF_TDBASE_ERR_OVERFLOW,
        0,
        0,
        0,
        0,
    ...
    assert tensor_lookup_span_by_abs_range(0x2080, 0x2090, starts, ends, sorted_idx) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
    ...
    assert tensor_lookup_span_by_abs_range(0x2010, 0x2050, starts, ends, sorted_idx) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
...
def test_tensor_lookup_span_by_abs_range_with_built_offset_index() -> None:
    rel_offsets = [0x280, 0x00, 0x2C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        ...
        assert tensor_lookup_span_by_abs_range(abs_start, abs_start, starts, ends, sorted_idx) == (
            GGUF_TDBASE_OK,
            original_idx,
            abs_start,
            abs_end,
        ...
        if nbytes > 1:
            mid_start = abs_start + (nbytes // 4)
            mid_end = abs_start + ((3 * nbytes) // 4)
            err, tensor_index, out_start, out_end, span_start, span_end = tensor_lookup_span_by_abs_range(
                mid_start,
                mid_end,
                starts,
                ends,
            ...
            assert tensor_index == original_idx
            assert out_start == abs_start
            assert out_end == abs_end
            assert span_start == (mid_start - abs_start)
            assert span_end == (mid_end - abs_start)

        # Crossing into next tensor must fail.
        if original_idx + 1 < len(rel_offsets):
            next_abs_start = 0x5000 + rel_offsets[original_idx + 1]
            if next_abs_start > abs_start and next_abs_start < abs_end + 0x400:
                assert tensor_lookup_span_by_abs_range(abs_start, next_abs_start + 1, starts, ends, sorted_idx) == (
                    GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
                    0,
                    0,
                    0,
...
def test_tensor_lookup_span_by_rel_range_happy_path() -> None:
    tensor_data_base = 0x4000
    alignment = 32
    starts = [0x4000, 0x4080, 0x4100]
    ends = [0x4040, 0x40C0, 0x4140]
    sorted_idx = [0, 1, 2]

    assert tensor_lookup_span_by_rel_range(
        0x80,
        0xA0,
        tensor_data_base,
        alignment,
...
def test_tensor_lookup_span_by_rel_range_propagates_errors() -> None:
    tensor_data_base = 0x5000
    starts = [0x5000, 0x5080]
    ends = [0x5040, 0x50C0]
    sorted_idx = [0, 1]
    ...
    assert tensor_lookup_span_by_rel_range(
        ...
        ends,
        sorted_idx,
    ) == (GGUF_TDBASE_ERR_MISALIGNED_TENSOR_OFFSET, 0, 0, 0, 0, 0)
...
def test_tensor_lookup_span_by_rel_range_with_built_offset_index() -> None:
    rel_offsets = [0x000, 0x080, 0x100, 0x200]
    elem_counts = [32, 64, 128, 32]
    ggml_types = [GGML_TYPE_Q4_0, GGML_TYPE_Q8_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ends = [0, 0, 0, 0]
    sorted_idx = [0, 0, 0, 0]

    err, bad = tensor_info_build_offset_index(
        tensor_data_base=0x6000,
        alignment=32,
        gguf_file_nbytes=0x9000,
        tensor_rel_offsets=rel_offsets,
        tensor_element_counts=elem_counts,
    ...
    for original_idx in range(len(rel_offsets)):
        abs_start = 0x6000 + rel_offsets[original_idx]
        err_n, nbytes = tensor_bytes_for_type(ggml_types[original_idx], elem_counts[original_idx])
        assert err_n == GGUF_TDBASE_OK
        ...
        rel_start = rel_offsets[original_idx]
        rel_end = rel_start + (nbytes // 2)

        if (rel_end % 32) != 0:
            rel_end = ((rel_end + 31) // 32) * 32
        if rel_end > rel_offsets[original_idx] + nbytes:
            rel_end = rel_offsets[original_idx] + nbytes

        if rel_end < rel_start:
            continue

        err, tensor_index, out_start, out_end, span_start, span_end = tensor_lookup_span_by_rel_range(
            rel_start,
            rel_end,
            0x6000,
            32,
        ...
        assert out_end == abs_start + nbytes
        assert span_start == 0
        assert span_end == (rel_end - rel_start)


def test_tensor_lookup_span_by_index_and_abs_range_happy_path() -> None:
    starts = [0x1000, 0x1080, 0x1100]
    ends = [0x1020, 0x10B0, 0x1160]
    sorted_idx = [2, 0, 1]
    sorted_pos = [1, 2, 0]

    assert tensor_lookup_span_by_index_and_abs_range(2, 0x1000, 0x1000, starts, ends, sorted_pos) == (
        GGUF_TDBASE_OK,
        0x1000,
        0x1020,
        0,
    ...
    assert tensor_lookup_span_by_index_and_abs_range(0, 0x1090, 0x10A2, starts, ends, sorted_pos) == (
        GGUF_TDBASE_OK,
        0x1080,
        0x10B0,
        0x10,
    ...
    assert tensor_lookup_span_by_index_and_abs_range(1, 0x1120, 0x115F, starts, ends, sorted_pos) == (
        GGUF_TDBASE_OK,
        0x1100,
        0x1160,
        0x20,
    ...
    # Cross-check consistency with start-offset lookup helper.
    err, owner, _, _ = tensor_lookup_by_abs_offset(0x1090, starts, ends, sorted_idx)
    assert err == GGUF_TDBASE_OK
    assert owner == 0


def test_tensor_lookup_span_by_index_and_abs_range_propagates_errors() -> None:
    starts = [0x2000, 0x2100]
    ends = [0x2040, 0x2140]
    sorted_pos = [0, 1]

    assert tensor_lookup_span_by_index_and_abs_range(0, 0x2030, 0x2020, starts, ends, sorted_pos) == (
        GGUF_TDBASE_ERR_OVERFLOW,
        0,
        0,
        0,
    ...
    assert tensor_lookup_span_by_index_and_abs_range(2, 0x2010, 0x2020, starts, ends, sorted_pos) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
    ...
    assert tensor_lookup_span_by_index_and_abs_range(0, 0x1FF0, 0x2020, starts, ends, sorted_pos) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
    ...
    assert tensor_lookup_span_by_index_and_abs_range(0, 0x2010, 0x2050, starts, ends, sorted_pos) == (
        GGUF_TDBASE_ERR_OUT_OF_BOUNDS,
        0,
        0,
        0,
...
def test_tensor_lookup_span_by_index_and_abs_range_with_built_lookup_tables() -> None:
    rel_offsets = [0x280, 0x00, 0x2C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        ...
        assert tensor_lookup_span_by_index_and_abs_range(
            original_idx,
            abs_start,
            abs_start,
            starts,
        ...
        if nbytes > 1:
            mid_start = abs_start + (nbytes // 4)
            mid_end = abs_start + ((3 * nbytes) // 4)
            err, out_start, out_end, span_start, span_end = tensor_lookup_span_by_index_and_abs_range(
                original_idx,
                mid_start,
                mid_end,
                starts,
        ...
        # Range that extends past selected tensor end must fail.
        if original_idx + 1 < len(rel_offsets):
            next_start = 0x7000 + rel_offsets[original_idx + 1]
            if next_start > abs_end:
                assert tensor_lookup_span_by_index_and_abs_range(
                    original_idx,
                    abs_start,
                    next_start,
...
def test_tensor_lookup_span_by_index_and_rel_range_default_happy_path() -> None:
    tensor_data_base = 0x7000
    starts = [0x7000, 0x7080, 0x7100]
    ends = [0x7040, 0x70C0, 0x7140]
    sorted_pos = [0, 1, 2]

    assert tensor_lookup_span_by_index_and_rel_range_default(
        1,
        0x80,
        0xA0,
        tensor_data_base,
...
def test_tensor_lookup_span_by_index_and_rel_range_default_propagates_errors() -> None:
    tensor_data_base = 0x7000
    starts = [0x7000, 0x7080]
    ends = [0x7040, 0x70C0]
    sorted_pos = [0, 1]
...
def test_tensor_lookup_span_by_index_and_rel_range_default_with_built_lookup_tables() -> None:
    rel_offsets = [0x280, 0x00, 0x2C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        ...
        rel_end = rel_start + nbytes
        if nbytes >= GGUF_DEFAULT_ALIGNMENT:
            mid_rel = rel_start + (nbytes // 2)
            mid_rel = ((mid_rel + (GGUF_DEFAULT_ALIGNMENT - 1)) // GGUF_DEFAULT_ALIGNMENT) * GGUF_DEFAULT_ALIGNMENT
            if mid_rel <= rel_end:
                err_mid, out_start, out_end, span_start, span_end = tensor_lookup_span_by_index_and_rel_range_default(
                    original_idx,
                    mid_rel,
                    mid_rel,
                    0x7000,
                ...
                assert out_start == starts[sorted_pos[original_idx]]
                assert out_end == ends[sorted_pos[original_idx]]
                assert span_start == (0x7000 + mid_rel - out_start)
                assert span_end == span_start


def test_tensor_info_load_payload_window_by_index_rel_default_happy_path() -> None:
    tensor_data_base = 0x7000
    starts = [0x7000, 0x7080, 0x7100]
    ends = [0x7040, 0x70C0, 0x7140]
    sorted_pos = [0, 1, 2]
...
def test_tensor_info_load_payload_window_by_index_rel_default_propagates_errors() -> None:
    ...
    assert tensor_info_load_payload_window_by_index_rel_default(
        ...
        ends,
        sorted_pos,
    ) == (GGUF_TDBASE_ERR_MISALIGNED_BASE, 0, 0, 0, 0)
...
def test_tensor_info_load_payload_window_by_index_rel_default_with_built_lookup_tables() -> None:
    ...
    for original_idx in range(len(rel_offsets)):
        ...
        out = tensor_info_load_payload_window_by_index_rel_default(
            original_idx,
            rel_start,
            rel_start,
            0x7000,
        ...
        rel_end = rel_start + nbytes
        out_full = tensor_info_load_payload_window_by_index_rel_default(
            original_idx,
            rel_start,
            rel_end,
            0x7000,
        ...
        if nbytes >= GGUF_DEFAULT_ALIGNMENT:
            ...
            mid_rel = ((mid_rel + (GGUF_DEFAULT_ALIGNMENT - 1)) // GGUF_DEFAULT_ALIGNMENT) * GGUF_DEFAULT_ALIGNMENT
            if mid_rel <= rel_end:
                err_mid, out_abs_start, out_abs_end, span_start, span_end = tensor_info_load_payload_window_by_index_rel_default(
                    original_idx,
                    mid_rel,
                    mid_rel,
                    0x7000,
                ...
                assert err_mid == GGUF_TDBASE_OK
                assert out_abs_start == 0x7000 + mid_rel
                assert out_abs_end == 0x7000 + mid_rel
                assert span_start == (0x7000 + mid_rel - starts[sorted_pos[original_idx]])
                assert span_end == span_start


def test_tensor_info_load_payload_window_by_index_rel_happy_path_custom_alignment() -> None:
    tensor_data_base = 0x7200
    starts = [0x7200, 0x7240, 0x72A0]
    ends = [0x7240, 0x7280, 0x72E0]
    sorted_pos = [0, 1, 2]

    assert tensor_info_load_payload_window_by_index_rel(
        1,
        0x40,
        0x70,
        tensor_data_base,
...
def test_tensor_info_load_payload_window_by_index_rel_propagates_errors() -> None:
    tensor_data_base = 0x7200
    ...
    assert tensor_info_load_payload_window_by_index_rel(
        ...
        ends,
        sorted_pos,
    ) == (GGUF_TDBASE_ERR_BAD_ALIGNMENT, 0, 0, 0, 0)

    assert tensor_info_load_payload_window_by_index_rel(
        0,
        0x00,
        0x20,
        tensor_data_base + 0x20,
        64,
        starts,
        ends,
        sorted_pos,
...
def test_tensor_info_load_payload_window_by_index_rel_with_built_lookup_tables_custom_alignment() -> None:
    rel_offsets = [0x180, 0x00, 0x1C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ends = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        ...
        out = tensor_info_load_payload_window_by_index_rel(
            original_idx,
            rel_start,
            rel_start,
            0x7200,
        ...
        rel_end = rel_start + nbytes
        out_full = tensor_info_load_payload_window_by_index_rel(
            original_idx,
            rel_start,
            rel_end,
            0x7200,
        ...
        if nbytes >= 64:
            mid_rel = rel_start + (nbytes // 2)
            mid_rel = ((mid_rel + 63) // 64) * 64
            if mid_rel <= rel_end:
                err_mid, out_abs_start, out_abs_end, span_start, span_end = tensor_info_load_payload_window_by_index_rel(
                    original_idx,
                    mid_rel,
                    mid_rel,
                    0x7200,
                ...
                assert err_mid == GGUF_TDBASE_OK
                assert out_abs_start == 0x7200 + mid_rel
                assert out_abs_end == 0x7200 + mid_rel
                assert span_start == (0x7200 + mid_rel - starts[sorted_pos[original_idx]])
                assert span_end == span_start


def test_tensor_info_load_payload_window_by_rel_span_happy_path_custom_alignment() -> None:
    tensor_data_base = 0x7200
    starts = [0x7200, 0x7240, 0x72A0]
    ends = [0x7240, 0x7280, 0x72E0]
    sorted_idx = [0, 1, 2]

    assert tensor_info_load_payload_window_by_rel_span(
        0x40,
        0x70,
        tensor_data_base,
        64,
...
def test_tensor_info_load_payload_window_by_rel_span_propagates_errors() -> None:
    tensor_data_base = 0x7200
    starts = [0x7200, 0x7240]
    ends = [0x7240, 0x7280]
    sorted_idx = [0, 1]
    ...
    assert tensor_info_load_payload_window_by_rel_span(
        ...
        ends,
        sorted_idx,
    ) == (GGUF_TDBASE_ERR_BAD_ALIGNMENT, 0, 0, 0, 0, 0)
...
def test_tensor_info_load_payload_window_by_rel_span_with_built_lookup_tables_custom_alignment() -> None:
    rel_offsets = [0x280, 0x00, 0x2C0, 0x40]
    elem_counts = [32, 64, 32, 128]
    ggml_types = [GGML_TYPE_Q8_0, GGML_TYPE_Q4_0, GGML_TYPE_F16, GGML_TYPE_F32]
    starts = [0, 0, 0, 0]
    ...
    for original_idx in range(len(rel_offsets)):
        ...
        out = tensor_info_load_payload_window_by_rel_span(
            rel_start,
            rel_start,
            0x7200,
            64,
        ...
        rel_end = rel_start + nbytes
        out_full = tensor_info_load_payload_window_by_rel_span(
            rel_start,
            rel_end,
            0x7200,
            64,
        ...
        if nbytes >= 64:
            mid_rel = rel_start + (nbytes // 2)
            mid_rel = ((mid_rel + 63) // 64) * 64
            if mid_rel < rel_end and mid_rel >= rel_start:
                err_mid, out_tensor_index, out_abs_start, out_abs_end, span_start, span_end = tensor_info_load_payload_window_by_rel_span(
                    mid_rel,
                    mid_rel,
                    0x7200,
                    64,
...
def run() -> None:
    ...
    test_tensor_lookup_by_abs_offset_default_happy_path()
    ...
    test_tensor_lookup_by_abs_offset_default_with_built_offset_index()
    test_tensor_lookup_by_abs_offset_with_inner_offset_happy_path()
    test_tensor_lookup_by_abs_offset_with_inner_offset_propagates_errors()
    test_tensor_lookup_by_abs_offset_with_inner_offset_with_built_offset_index()
    ...
    test_tensor_lookup_span_by_abs_range_happy_path()
    test_tensor_lookup_span_by_abs_range_propagates_errors()
    test_tensor_lookup_span_by_abs_range_with_built_offset_index()
    test_tensor_lookup_span_by_rel_range_happy_path()
    test_tensor_lookup_span_by_rel_range_propagates_errors()
    test_tensor_lookup_span_by_rel_range_with_built_offset_index()
    ...
    test_tensor_lookup_span_by_index_and_rel_range_default_happy_path()
    test_tensor_lookup_span_by_index_and_rel_range_default_propagates_errors()
    test_tensor_lookup_span_by_index_and_rel_range_default_with_built_lookup_tables()
    ...
    test_tensor_info_build_lookup_tables_staged_rejects_malformed_permutation()
    test_tensor_info_build_lookup_tables_adversarial_overlap_matrix()
    ...
    test_tensor_range_find_by_index_matches_tensor_index_to_abs_range()
    test_tensor_range_find_by_index_propagates_bounds_error()
    test_tensor_range_find_by_index_with_built_offset_index()
