...
def attention_q16_compute_scaled_qk_rows_checked_nopartial_default_stride_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity_preflight_only(
    q_rows_q16,
    q_rows_capacity: int,
    query_row_count: int,
    k_rows_q16,
...
def test_source_contains_default_stride_alias_safe_required_bytes_default_capacity_preflight_only_wrapper() -> None:
    source = Path("src/model/attention.HC").read_text(encoding="utf-8")
    signature = "I32 AttentionQ16ComputeScaledQKRowsCheckedNoPartialDefaultStrideNoAllocRequiredBytesCommitCapacityAliasSafeDefaultCapacityPreflightOnly("
...
def test_known_vector_and_alias_rejection() -> None:
    ...
    err_got = attention_q16_compute_scaled_qk_rows_checked_nopartial_default_stride_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity_preflight_only(
        q_rows,
        len(q_rows),
        3,
        k_rows,
    ...
    err_alias = attention_q16_compute_scaled_qk_rows_checked_nopartial_default_stride_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity_preflight_only(
        q_rows,
        len(q_rows),
        3,
        k_rows,
...
def test_randomized_parity() -> None:
    rng = random.Random(20260420_662)
...
if __name__ == "__main__":
    test_source_contains_default_stride_alias_safe_required_bytes_default_capacity_preflight_only_wrapper()
