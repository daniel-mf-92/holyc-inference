...
def ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity(
    gate_q16,
    gate_capacity: int,
    up_q16,
    up_capacity: int,
    ...
    *,
    ...
    return alias_safe.ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_required_bytes_commit_capacity_alias_safe(
        gate_q16,
        gate_capacity,
        up_q16,
        up_capacity,
...
def explicit_checked_alias_safe_default_capacity_composition(
    gate_q16,
    gate_capacity: int,
    up_q16,
    up_capacity: int,
    ...
    *,
    ...
    return ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity(
        gate_q16,
        gate_capacity,
        up_q16,
        up_capacity,
...
def test_source_contains_alias_safe_default_capacity_wrapper() -> None:
    ...
    signature = (
        "I32 FFNQ16SwiGLUApplyRowsCheckedNoPartialStridedNoAllocRequiredBytesCommitCapacityAliasSafeDefaultCapacity("
    )
...
def test_known_vectors_and_overlap_rejection() -> None:
    ...
    err = (
        ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity(
            gate,
            96,
            up,
            96,
...
def test_randomized_parity_vs_explicit_composition() -> None:
    ...
    for _ in range(350):
        ...
        err_got = ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_required_bytes_commit_capacity_alias_safe_default_capacity(
            gate,
            gate_capacity,
            up,
            up_capacity,
        ...
        err_exp = explicit_checked_alias_safe_default_capacity_composition(
            gate,
            gate_capacity,
            up,
            up_capacity,
