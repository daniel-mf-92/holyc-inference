#!/usr/bin/env python3
"""Reference checks for ...ParityCommitOnlyPreflightOnly (IQ-1382)."""
...
def gqa_attention_apply_softmax_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only(
    scores_q32,
    scores_capacity: int,
    query_rows: int,
    key_rows: int,
...
def test_randomized_parity_commit_preflight_publish_path() -> None:
    rng = random.Random(20260425_1382)
...
if __name__ == "__main__":
    ...
    print(
        ...
        "parity_commit_only_preflight_only_reference_checks=ok"
    )
