...
def replay_guard_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only(
    cache,
    entry_index: int,
    access_tick: int,
    profile_id: int,
...
def test_commit_only_hardening_secure_local_monotonic_roundtrip():
...
def test_commit_only_hardening_dev_local_allows_rollback():
...
def test_commit_only_hardening_secure_local_policy_failure_keeps_output_slots_unchanged():
...
def test_commit_only_hardening_rejects_bad_vectors():
...
if __name__ == "__main__":
    test_commit_only_hardening_secure_local_monotonic_roundtrip()
