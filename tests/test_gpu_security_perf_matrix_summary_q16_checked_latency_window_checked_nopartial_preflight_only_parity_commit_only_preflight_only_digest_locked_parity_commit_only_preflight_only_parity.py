#!/usr/bin/env python3
"""Harness for IQ-1566 digest-locked latency-window strict diagnostics parity gate."""
...
def _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only(
    rows: list[RowOutput],
    rows_capacity: int,
    out_capacity: int,
    secure_local_mode: int,
    ...
    status_preflight, _, staged_tuple = _latency_window_nopartial_preflight_only(
        rows,
        rows_capacity,
        out_capacity,
        secure_local_mode,
    ...
    if status_parity != GPU_SEC_PERF_OK:
        return status_parity, (0, 0, 0, 0)
    if parity_tuple != staged_tuple:
        return GPU_SEC_PERF_ERR_BAD_PARAM, (0, 0, 0, 0)
    return GPU_SEC_PERF_OK, parity_tuple


def _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only(
    rows: list[RowOutput],
    rows_capacity: int,
    out_capacity: int,
    secure_local_mode: int,
    ...
    status_commit_only, staged_tuple = _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only(
        rows,
        rows_capacity,
        out_capacity,
        secure_local_mode,
    ...
    status_canonical, _, canonical_tuple = _latency_window_nopartial_preflight_only(
        rows,
        rows_capacity,
        out_capacity,
        secure_local_mode,
    ...
    if status_commit_only != GPU_SEC_PERF_OK:
        return status_commit_only, (0, 0, 0, 0)
    return GPU_SEC_PERF_OK, canonical_tuple


def _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only_parity(
    rows: list[RowOutput],
    rows_capacity: int,
    out_capacity: int,
    secure_local_mode: int,
    ...
    status_preflight_only, staged_tuple = _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only(
        rows,
        rows_capacity,
        out_capacity,
        secure_local_mode,
    ...
    status_commit_only, canonical_tuple = _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only(
        rows,
        rows_capacity,
        out_capacity,
        secure_local_mode,
    ...
    if status_preflight_only != GPU_SEC_PERF_OK:
        return status_preflight_only, (0, 0, 0, 0)
    if staged_tuple != canonical_tuple:
        return GPU_SEC_PERF_ERR_BAD_PARAM, (0, 0, 0, 0)
    return GPU_SEC_PERF_OK, canonical_tuple


def gpu_security_perf_matrix_summary_q16_checked_latency_window_checked_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only_parity(
    ...
    status_parity, parity_tuple = _latency_window_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only_parity(
        rows,
        rows_capacity,
        out_capacity,
        secure_local_mode,
    ...
    if status_parity not in valid_status:
        return GPU_SEC_PERF_ERR_BAD_PARAM, caller_outputs, (0, 0, 0, 0)
    ...
    return GPU_SEC_PERF_OK, caller_outputs, parity_tuple


def test_source_contains_iq1566_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")

    assert "I32 GPUSecurityPerfMatrixSummaryQ16CheckedLatencyWindowCheckedNoPartialPreflightOnlyParityCommitOnlyPreflightOnlyDigestLockedParityCommitOnlyPreflightOnlyParity(" in src
    ...
    assert "status_commit_only = GPUSecurityPerfMatrixSummaryQ16CheckedLatencyWindowCheckedNoPartialPreflightOnlyParityCommitOnlyPreflightOnlyDigestLockedParityCommitOnly(" in src
...
def test_duplicate_latency_success_zero_write_diagnostics() -> None:
    rows = [
    ...
    status, preserved, published = gpu_security_perf_matrix_summary_q16_checked_latency_window_checked_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only_parity(
        rows,
        rows_capacity=5,
        out_capacity=4,
...
def test_null_alias_capacity_gate_missing_digest_drift_vectors() -> None:
    ...
    status, *_ = gpu_security_perf_matrix_summary_q16_checked_latency_window_checked_nopartial_preflight_only_parity_commit_only_preflight_only_digest_locked_parity_commit_only_preflight_only_parity(
        rows,
        rows_capacity=1,
        out_capacity=4,
        secure_local_mode=GPU_SEC_PERF_PROFILE_SECURE_LOCAL,
...
if __name__ == "__main__":
    test_source_contains_iq1566_symbols()
    test_duplicate_latency_success_zero_write_diagnostics()
