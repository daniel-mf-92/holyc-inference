#!/usr/bin/env python3
"""Parity harness for TokenizerBPEEncodePromptCheckedNoAllocFromLensCommitOnlyRequiredBytes."""
...
def tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes(
    data: list[int] | None,
    byte_len: int,
    ...
    staged_required_merge_workspace_bytes = staged_required[0] * staged_max_piece_len[0]
    if staged_required_merge_workspace_bytes > I64_MAX:
        return TOKENIZER_BPE_ERR_OVERFLOW
...
def test_source_contains_required_bytes_signature_and_atomic_publish() -> None:
    source = Path("src/tokenizer/bpe.HC").read_text(encoding="utf-8")
    sig = "I32 TokenizerBPEEncodePromptCheckedNoAllocFromLensCommitOnlyRequiredBytes("
...
def test_fuzz_parity() -> None:
    ...
    for _ in range(128):
        ...
        err_a = tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes(
            payload,
            nbytes,
            cur_a,
            prompt_nbytes,
