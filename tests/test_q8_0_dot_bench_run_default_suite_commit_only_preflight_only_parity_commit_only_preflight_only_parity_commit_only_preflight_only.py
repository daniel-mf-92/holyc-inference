...
def commit_only_preflight_only_parity_commit_only_preflight_only(
    cpu_hz: int,
...
def test_source_contains_iq1306_function_and_guards() -> None:
    source = Path("src/bench/q8_0_dot_bench.HC").read_text(encoding="utf-8")
    sig = "I32 Q8_0DotBenchRunDefaultSuiteCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnly("
...
def test_null_and_alias_guards() -> None:
    assert (
        commit_only_preflight_only_parity_commit_only_preflight_only(
            3_200_000_000,
            None,
            [1],
            [1],
    ...
    same = [77]
    status = commit_only_preflight_only_parity_commit_only_preflight_only(
        3_200_000_000,
        same,
        same,
        [3],
...
if __name__ == "__main__":
    test_source_contains_iq1306_function_and_guards()
