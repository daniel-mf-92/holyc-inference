#!/usr/bin/env python3
"""Harness for IQ-1777 fast-path batch audit strict diagnostics parity gate."""
...
import test_gpu_security_perf_fast_path_switch_batch_audit_q64_iq1776 as iq1776
...
HC_FN_IQ1777 = ""
HC_FN_PRIMARY = iq1776.HC_FN_IQ1776
...
def iq1777_model(
    ...
    *,
    ...
    status_primary, staged_tuple = iq1776.iq1776_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
...
def test_source_contains_iq1777_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert f"I32 {HC_FN_IQ1777}(" in src
    ...
    assert "// IQ-1777 strict diagnostics parity gate:" in src


def test_gate_missing_vector() -> None:
    saved_out = (3701, 3702, 3703, 3704)
    status, out_values = iq1777_model(
...
if __name__ == "__main__":
    test_source_contains_iq1777_symbols()
