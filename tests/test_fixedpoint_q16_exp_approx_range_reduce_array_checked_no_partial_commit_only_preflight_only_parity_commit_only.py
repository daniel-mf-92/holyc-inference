#!/usr/bin/env python3
"""Parity harness for FPQ16...CommitOnlyPreflightOnlyParityCommitOnly (IQ-918)."""
...
from test_fixedpoint_q16_exp_approx_range_reduce_array_checked_no_partial_commit_only_preflight_only_parity import (
    fpq16_exp_approx_range_reduce_checked_no_partial_array_commit_only_preflight_only_parity,
)


def fpq16_exp_approx_range_reduce_checked_no_partial_array_commit_only_preflight_only_parity_commit_only(
    x_q16: list[int] | None,
    out_k: list[int] | None,
...
def test_source_contains_iq918_helper() -> None:
    source = Path("src/math/fixedpoint.HC").read_text(encoding="utf-8")
    sig = "I32 FPQ16ExpApproxRangeReduceCheckedNoPartialArrayCommitOnlyPreflightOnlyParityCommitOnly(I64 *x_q16,"
...
def test_randomized_parity_vs_explicit_composition() -> None:
    rng = random.Random(20260421_918)
    ...
    for _ in range(1200):
        ...
        status_impl = fpq16_exp_approx_range_reduce_checked_no_partial_array_commit_only_preflight_only_parity_commit_only(
            x,
            out_k,
            out_r,
            count,
...
if __name__ == "__main__":
    test_source_contains_iq918_helper()
