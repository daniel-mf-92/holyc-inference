#!/usr/bin/env python3
"""Harness for ...ParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParity (IQ-1097)."""
...
def inference_generate_tokens_checked_topk_topp_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only_parity_reference(
    *,
    ...
    parity_fn=inference_generate_tokens_checked_topk_topp_commit_only_preflight_only_parity_commit_only_preflight_only_reference,
    commit_fn=inference_generate_tokens_checked_topk_topp_commit_only_preflight_only_parity_commit_only_reference,
) -> int:
    if (
...
def test_source_contains_iq_1097_symbol() -> None:
...
def test_adversarial_matrix_parity_with_explicit_composition() -> None:
    ...
    for _ in range(256):
        ...
        out_tokens = [808]
        out_final = [707]
        status = inference_generate_tokens_checked_topk_topp_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only_parity_reference(
            **kwargs,
