...
def softmax_q16_stable_topk_checked_nopartial_commit_only_preflight_only_parity_commit_only_iq1104(
...
def test_known_vector() -> None:
    ...
    err = softmax_q16_stable_topk_checked_nopartial_commit_only_preflight_only_parity_commit_only_iq1104(
        logits,
        logits_count=4,
        top_k=2,
...
def test_fuzz_parity_vs_components() -> None:
    rng = random.Random(20260422_1104)
