...
import test_ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only as strided_preflight
...
def ffn_q16_swiglu_apply_rows_checked_nopartial_default_stride_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
    gate_q16,
    gate_capacity: int,
    up_q16,
    up_capacity: int,
    ...
    *,
    ...
    return strided_preflight.ffn_q16_swiglu_apply_rows_checked_nopartial_strided_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
        gate_q16,
        gate_capacity,
        up_q16,
        up_capacity,
...
def explicit_checked_default_stride_preflight_composition(
    ...
    *,
    ...
    return ffn_q16_swiglu_apply_rows_checked_nopartial_default_stride_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
        gate_q16,
        gate_capacity,
        up_q16,
        up_capacity,
...
def test_source_contains_default_stride_alias_safe_preflight_helper() -> None:
    source = Path("src/model/ffn.HC").read_text(encoding="utf-8")
    signature = "I32 FFNQ16SwiGLUApplyRowsCheckedNoPartialDefaultStrideNoAllocCommitCapacityAliasSafeDefaultCapacityPreflightOnly("
...
def test_known_vectors_and_overlap_rejection() -> None:
    ...
    err = ffn_q16_swiglu_apply_rows_checked_nopartial_default_stride_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
        gate,
        96,
        up,
        96,
...
def test_randomized_parity_vs_explicit_composition() -> None:
    ...
    for _ in range(300):
        ...
        err_got = ffn_q16_swiglu_apply_rows_checked_nopartial_default_stride_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
            gate,
            gate_capacity,
            up,
            up_capacity,
...
if __name__ == "__main__":
    test_source_contains_default_stride_alias_safe_preflight_helper()
