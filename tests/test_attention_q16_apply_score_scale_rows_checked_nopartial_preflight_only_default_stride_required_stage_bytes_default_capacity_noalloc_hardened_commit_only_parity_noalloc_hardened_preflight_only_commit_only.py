#!/usr/bin/env python3
"""Parity harness for ...CommitOnlyParityNoAllocHardenedPreflightOnlyCommitOnly."""
...
def attention_q16_apply_score_scale_rows_checked_nopartial_preflight_only_default_stride_required_stage_bytes_default_capacity_noalloc_hardened_commit_only_parity_noalloc_hardened_preflight_only_commit_only(
    in_scores_q32,
...
def test_source_contains_commit_only_parity_noalloc_hardened_preflight_only() -> None:
    ...
    sig = "I32 AttentionQ16ApplyScoreScaleRowsCheckedNoPartialPreflightOnlyDefaultStrideRequiredStageBytesDefaultCapacityNoAllocHardenedCommitOnlyParityNoAllocHardenedPreflightOnlyCommitOnly("
...
def test_randomized_parity() -> None:
    ...
    for _ in range(220):
        ...
        err_a = attention_q16_apply_score_scale_rows_checked_nopartial_preflight_only_default_stride_required_stage_bytes_default_capacity_noalloc_hardened_commit_only_parity_noalloc_hardened_preflight_only_commit_only(
            in_scores,
            len(in_scores),
            row_count,
            token_count,
