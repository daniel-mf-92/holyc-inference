#!/usr/bin/env python3
"""Parity harness for ...CommitOnlyDefaultCapacityPreflightOnlyHardened."""
...
def tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes_commit_only_default_capacity_preflight_only_hardened(
    data: list[int] | None,
    byte_len: int,
    ...
    if err != TOKENIZER_BPE_OK:
        return err
    if staged_cursor != initial_cursor:
...
def test_source_contains_signature_and_hardening_calls() -> None:
    ...
    sig = "I32 TokenizerBPEEncodePromptCheckedNoAllocFromLensCommitOnlyRequiredBytesCommitOnlyDefaultCapacityPreflightOnlyHardened("
...
def test_null_overflow_and_fuzz_parity() -> None:
    ...
    err = tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes_commit_only_default_capacity_preflight_only_hardened(
        None,
        0,
        [0],
        0,
