...
def attention_q16_compute_scaled_qk_rows_checked_nopartial_strided_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
    q_rows_q16,
    q_rows_capacity: int,
    query_row_count: int,
...
def test_source_contains_alias_safe_default_capacity_preflight_helper() -> None:
    ...
    signature = "I32 AttentionQ16ComputeScaledQKRowsCheckedNoPartialStridedNoAllocCommitCapacityAliasSafeDefaultCapacityPreflightOnly("
...
def test_known_vectors_and_alias_rejection() -> None:
    ...
    err_got = attention_q16_compute_scaled_qk_rows_checked_nopartial_strided_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
        q_rows,
        len(q_rows),
        3,
        8,
    ...
    err_alias = attention_q16_compute_scaled_qk_rows_checked_nopartial_strided_noalloc_commit_capacity_alias_safe_default_capacity_preflight_only(
        q_rows,
        len(q_rows),
        3,
        8,
...
def test_randomized_parity() -> None:
    rng = random.Random(20260420_653)
...
if __name__ == "__main__":
    test_source_contains_alias_safe_default_capacity_preflight_helper()
