#!/usr/bin/env python3
"""Harness for IQ-1766 fast-path batch audit zero-write diagnostics companion."""
...
GPU_SEC_PERF_OK = iq1765.GPU_SEC_PERF_OK
GPU_SEC_PERF_ERR_BAD_PARAM = iq1765.GPU_SEC_PERF_ERR_BAD_PARAM
GPU_SEC_PERF_PROFILE_SECURE_LOCAL = iq1765.GPU_SEC_PERF_PROFILE_SECURE_LOCAL

Scenario = iq1765.Scenario

HC_FN_IQ1766 = "GPUSecurityPerfFastPathSwitchBatchAuditQ64CheckedCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnly"
HC_FN_COMPANION = iq1765.HC_FN_IQ1765
HC_FN_CANONICAL = iq1756.HC_FN_IQ1756
...
def iq1766_model(
    ...
    *,
    ...
    status_companion, staged_tuple = iq1765.iq1765_model(
        scenarios=scenarios,
    ...
    status_canonical, canonical_tuple = iq1756.iq1756_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
    ...
    status_is_valid = iq1756.iq1755.iq1754.iq1753.iq1752.iq1751.iq1750.iq1749.iq1748.iq1747.iq1746._status_is_valid
...
def test_source_contains_iq1766_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert f"I32 {HC_FN_IQ1766}(" in src
    ...
    assert "// IQ-1766 zero-write diagnostics companion:" in src


def test_gate_missing_vector() -> None:
    saved_out = (71, 72, 73, 74)
    status, out_values = iq1766_model(
...
if __name__ == "__main__":
    test_source_contains_iq1766_symbols()
