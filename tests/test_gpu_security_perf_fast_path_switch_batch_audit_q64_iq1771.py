#!/usr/bin/env python3
"""Harness for IQ-1771 fast-path batch audit strict diagnostics parity gate."""
...
GPU_SEC_PERF_OK = iq1769.GPU_SEC_PERF_OK
GPU_SEC_PERF_ERR_BAD_PARAM = iq1769.GPU_SEC_PERF_ERR_BAD_PARAM
GPU_SEC_PERF_PROFILE_SECURE_LOCAL = iq1769.GPU_SEC_PERF_PROFILE_SECURE_LOCAL

Scenario = iq1769.Scenario

HC_FN_IQ1771 = "GPUSecurityPerfFastPathSwitchBatchAuditQ64CheckedCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParity"
HC_FN_PRIMARY = iq1769.HC_FN_IQ1769
HC_FN_CANONICAL = iq1770.HC_FN_IQ1770
...
def iq1771_model(
    ...
    *,
    ...
    status_primary, staged_tuple = iq1769.iq1769_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
        ...
        force_digest_drift_canonical=force_digest_drift_primary,
    )

    status_canonical, canonical_tuple = iq1770.iq1770_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
...
def test_source_contains_iq1771_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert f"I32 {HC_FN_IQ1771}(" in src
    ...
    assert "// IQ-1771 strict diagnostics parity gate refresh:" in src


def test_gate_missing_vector() -> None:
    saved_out = (701, 702, 703, 704)
    status, out_values = iq1771_model(
...
if __name__ == "__main__":
    test_source_contains_iq1771_symbols()
