#!/usr/bin/env python3
"""Parity checks for Q8_0MatMulTiledAVX2Q32CheckedDefaultTiles semantics."""
...
def test_default_tiles_wrapper_matches_checked_core_randomized() -> None:
    ...
    for _ in range(180):
        ...
        err_default, out_default = q8_0_matmul_tiled_avx2_q32_checked_default_tiles(
        ...
        err_core, out_core = q8_0_matmul_tiled_avx2_q32_checked(
            lhs_matrix_blocks=lhs,
            lhs_block_capacity=lhs_rows * lhs_row_stride_blocks,
            lhs_rows=lhs_rows,
            lhs_row_stride_blocks=lhs_row_stride_blocks,
...
def test_default_tiles_wrapper_bad_len_and_null_parity() -> None:
    ...
    err, out = q8_0_matmul_tiled_avx2_q32_checked_default_tiles(
...
def run() -> None:
    ...
    print("q8_0_matmul_tiled_avx2_q32_checked_default_tiles_reference_checks=ok")
