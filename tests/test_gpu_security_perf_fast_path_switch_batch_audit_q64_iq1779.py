#!/usr/bin/env python3
"""Harness for IQ-1779 fast-path batch audit strict diagnostics parity gate."""
...
import test_gpu_security_perf_fast_path_switch_batch_audit_q64_iq1778 as iq1778

GPU_SEC_PERF_OK = iq1775.GPU_SEC_PERF_OK
GPU_SEC_PERF_ERR_BAD_PARAM = iq1775.GPU_SEC_PERF_ERR_BAD_PARAM
GPU_SEC_PERF_PROFILE_SECURE_LOCAL = iq1775.GPU_SEC_PERF_PROFILE_SECURE_LOCAL

Scenario = iq1775.Scenario

HC_FN_IQ1779 = ""
HC_FN_PRIMARY = iq1778.HC_FN_IQ1778
HC_FN_CANONICAL = iq1775.HC_FN_IQ1775
...
def iq1779_model(
    ...
    *,
    ...
    status_canonical, canonical_tuple = iq1775.iq1775_model(
        scenarios=scenarios,
        ...
        force_status_domain_drift_parity=force_status_domain_drift_canonical,
    )

    status_primary, staged_tuple = iq1778.iq1778_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
...
def test_source_contains_iq1779_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert f"I32 {HC_FN_IQ1779}(" in src
    ...
    assert "// IQ-1779 strict diagnostics parity gate:" in src


def test_gate_missing_vector() -> None:
    saved_out = (4701, 4702, 4703, 4704)
    status, out_values = iq1779_model(
...
if __name__ == "__main__":
    test_source_contains_iq1779_symbols()
