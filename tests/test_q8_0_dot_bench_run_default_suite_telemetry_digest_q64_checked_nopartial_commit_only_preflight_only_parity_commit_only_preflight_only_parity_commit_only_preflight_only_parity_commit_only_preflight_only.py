#!/usr/bin/env python3
"""Zero-write diagnostics companion checks for IQ-1348 telemetry digest wrapper."""
...
def test_source_contains_iq1348_function_and_guards() -> None:
    ...
    sig = (
        ...
        "CommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnly("
    )
...
def test_happy_path_is_zero_write() -> None:
    out = [0x123456]
...
def test_overflow_propagates_and_preserves_output() -> None:
    out = [111]
    status = telemetry_digest_q64_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only(
...
if __name__ == "__main__":
    test_source_contains_iq1348_function_and_guards()
    test_happy_path_is_zero_write()
    test_parity_mismatch_rejects_and_preserves_output()
    test_overflow_propagates_and_preserves_output()
    test_null_ptr()
    print("ok")
