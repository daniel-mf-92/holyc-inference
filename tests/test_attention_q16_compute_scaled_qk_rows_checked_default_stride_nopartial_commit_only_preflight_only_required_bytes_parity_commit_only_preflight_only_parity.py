#!/usr/bin/env python3
"""Parity harness for ...RequiredBytesParityCommitOnlyPreflightOnlyParity (IQ-1041)."""
...
def attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only(
    query_row_count: int,
    token_count: int,
    staged_scores_q32,
    staged_scores_capacity: int,
...
def attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_preflight_only(
    ...
    return attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only(
        query_row_count,
        token_count,
        staged_scores_q32,
        staged_scores_capacity,
...
def explicit_commit_only_preflight_only_parity_composition(
    query_row_count: int,
    token_count: int,
    staged_scores_q32,
    staged_scores_capacity: int,
...
def test_source_contains_required_bytes_parity_commit_only_preflight_only_parity_wrapper() -> None:
...
def test_known_vector_commit_only_preflight_only_parity_outputs() -> None:
    query_row_count = 7
    token_count = 6
...
def test_overflow_vectors_preserve_outputs() -> None:
    ...
    for query_row_count, token_count in (
        ...
        err_ref = explicit_commit_only_preflight_only_parity_composition(
            query_row_count,
            token_count,
            staged,
            i64_max,
...
def test_randomized_commit_only_preflight_only_parity_vs_explicit_composition() -> None:
    rng = random.Random(20260422_1041)
    ...
    for _ in range(1200):
        ...
        err_new = attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_preflight_only_parity(
            query_row_count,
            token_count,
            staged,
            staged_cap,
...
if __name__ == "__main__":
    test_source_contains_required_bytes_parity_commit_only_preflight_only_parity_wrapper()
    test_known_vector_commit_only_preflight_only_parity_outputs()
    test_error_paths_preserve_outputs()
    test_overflow_vectors_preserve_outputs()
    test_randomized_commit_only_preflight_only_parity_vs_explicit_composition()
    print(
        "attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_preflight_only_parity=ok"
    )
