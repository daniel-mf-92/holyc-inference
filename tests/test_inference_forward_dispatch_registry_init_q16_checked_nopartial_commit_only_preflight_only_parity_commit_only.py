...
def test_success_and_no_partial_error_contract() -> None:
...
def run() -> None:
    ...
    test_success_and_no_partial_error_contract()
    print("inference_forward_dispatch_registry_init_q16_checked_nopartial_commit_only_preflight_only_parity_commit_only=ok")
