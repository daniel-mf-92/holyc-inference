#!/usr/bin/env python3
"""Parity harness for TokenizerBPEDecodeSingleTokenCheckedDefaultCapacityNoPartialValidateCursor."""
...
def tokenizer_bpe_decode_single_token_checked_default_capacity_no_partial_validate_cursor(
    token_id: int,
...
def run_case(
    ...
    err_wrapper = tokenizer_bpe_decode_single_token_checked_default_capacity_no_partial_validate_cursor(
        token_id,
        blob,
        len(blob),
        offsets,
...
def test_adversarial_cursor_and_token_vectors() -> None:
    ...
    for bad_token in (-1, 99):
        ...
        err = tokenizer_bpe_decode_single_token_checked_default_capacity_no_partial_validate_cursor(
            bad_token,
            blob,
            len(blob),
            offsets,
...
def test_randomized_parity() -> None:
    rng = random.Random(20260419_443)
