#!/usr/bin/env python3
"""Reference checks for GQAAttentionValueMixQ16CheckedNoPartialCommitOnlyPreflightOnlyParity (IQ-1380)."""
...
def gqa_attention_value_mix_q16_checked_nopartial_commit_only_preflight_only_parity(
    scores_q16,
    scores_capacity: int,
    query_rows: int,
    key_rows: int,
    ...
    if out_values_q16[:required_out_cells] != snapshot_out:
        return ATTN_Q16_ERR_BAD_PARAM
...
def test_randomized_parity_publish_path() -> None:
    rng = random.Random(20260425_1380)
...
def test_source_contract_markers() -> None:
    ...
    marker = "I32 GQAAttentionValueMixQ16CheckedNoPartialCommitOnlyPreflightOnlyParity("
...
if __name__ == "__main__":
    ...
    print(
        "gqa_attention_value_mix_q16_checked_nopartial_commit_only_preflight_only_parity_reference_checks=ok"
    )
