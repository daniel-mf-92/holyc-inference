...
def gpu_security_perf_matrix_summary_q16_checked_latency_window_checked_nopartial_preflight_only_parity_commit_only(
...
def test_commit_only_success_publishes_duplicate_latency_tuple() -> None:
    ...
    status, persisted, staged = gpu_security_perf_matrix_summary_q16_checked_latency_window_checked_nopartial_preflight_only_parity_commit_only(
        rows,
        rows_capacity=5,
        out_capacity=4,
...
def test_overflow_vector_returns_bad_param_on_status_mismatch_and_preserves_outputs() -> None:
