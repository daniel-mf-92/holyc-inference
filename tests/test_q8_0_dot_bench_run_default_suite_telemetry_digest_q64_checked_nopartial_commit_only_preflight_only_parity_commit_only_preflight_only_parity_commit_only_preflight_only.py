#!/usr/bin/env python3
"""Zero-write diagnostics companion checks for IQ-1333 telemetry digest wrapper."""
...
def telemetry_digest_q64_checked_nopartial_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only(
    ...
    *,
    ...
    if commit_probe[0] != parity_probe[0]:
        return ERR_BAD_PARAM

    return ERR_OK


def test_source_contains_iq1333_function_and_guards() -> None:
...
if __name__ == "__main__":
    test_source_contains_iq1333_function_and_guards()
