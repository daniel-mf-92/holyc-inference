#!/usr/bin/env python3
"""Harness for IQ-1527 strict diagnostics parity gate over preflight/commit parity wrappers."""
...
def test_source_contains_iq1527_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")

    assert "I32 GPUSecurityPerfMatrixRowGateCheckedNoPartialPreflightOnlyCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParity(" in src
...
def test_null_alias_capacity_vectors() -> None:
    status, reason, allowed = row_gate_checked_nopartial_preflight_only_commit_only_preflight_only_parity_commit_only_preflight_only_parity(
...
if __name__ == "__main__":
    test_source_contains_iq1527_symbols()
