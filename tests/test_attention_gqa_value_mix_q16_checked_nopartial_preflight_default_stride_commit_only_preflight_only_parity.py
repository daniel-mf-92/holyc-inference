#!/usr/bin/env python3
"""Reference checks for GQAAttentionValueMixQ16CheckedNoPartialPreflightDefaultStrideCommitOnlyPreflightOnlyParity (IQ-1431)."""
...
from test_attention_gqa_value_mix_q16_checked_nopartial_preflight_default_stride_commit_only import (
    gqa_attention_value_mix_q16_checked_nopartial_preflight_default_stride_commit_only,
)
...
def gqa_attention_value_mix_q16_checked_nopartial_preflight_default_stride_commit_only_preflight_only_parity(
    scores_q16,
    scores_capacity: int,
    query_rows: int,
    key_rows: int,
...
def test_randomized_zero_write_parity_vectors() -> None:
    rng = random.Random(20260425_1431)
...
if __name__ == "__main__":
    ...
    print(
        "gqa_attention_value_mix_q16_checked_nopartial_preflight_default_stride_commit_only_preflight_only_parity_reference_checks=ok"
    )
