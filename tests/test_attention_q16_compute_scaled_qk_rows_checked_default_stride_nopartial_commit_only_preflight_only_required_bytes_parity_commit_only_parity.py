#!/usr/bin/env python3
"""Parity harness for ...RequiredBytesParityCommitOnlyParity (IQ-842)."""
...
from test_attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_preflight_only import (
    attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_preflight_only,
)


def attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_parity(
    query_row_count: int,
    token_count: int,
    staged_scores_q32,
...
def test_source_contains_required_bytes_parity_commit_only_parity_wrapper() -> None:
...
def test_randomized_commit_only_parity_vs_explicit_composition() -> None:
    ...
    for _ in range(1200):
        ...
        err_new = attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only_parity(
            query_row_count,
            token_count,
            staged,
            staged_cap,
