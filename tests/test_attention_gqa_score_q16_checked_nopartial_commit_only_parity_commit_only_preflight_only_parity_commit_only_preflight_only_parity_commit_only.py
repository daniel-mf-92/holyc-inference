#!/usr/bin/env python3
"""Reference checks for GQAAttentionScoreQ16CheckedNoPartialCommitOnlyParityCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnly (IQ-1440)."""
...
def gqa_attention_score_q16_checked_nopartial_commit_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only(
    q_rows_q16,
    q_rows_capacity: int,
    q_rows: int,
    k_rows_q16,
    ...
    if (
        staged_commit_q[0] != required_q_cells
...
def test_randomized_parity_success() -> None:
    rng = random.Random(20260425_1440)
...
if __name__ == "__main__":
    ...
    print("gqa_attention_score_q16_checked_nopartial_commit_only_parity_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only_reference_checks=ok")
