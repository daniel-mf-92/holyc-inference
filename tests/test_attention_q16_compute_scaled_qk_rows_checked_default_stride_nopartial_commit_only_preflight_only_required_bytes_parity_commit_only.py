#!/usr/bin/env python3
"""Parity harness for ...RequiredBytesParityCommitOnly (IQ-837)."""
...
def test_source_contains_required_bytes_parity_commit_only_wrapper() -> None:
...
def test_randomized_commit_only_vs_explicit_composition() -> None:
    rng = random.Random(20260421_837)
    ...
    for _ in range(1200):
        ...
        err_new = attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only(
            query_row_count,
            token_count,
            staged,
            staged_cap,
...
if __name__ == "__main__":
    test_source_contains_required_bytes_parity_commit_only_wrapper()
    ...
    print(
        "attention_q16_compute_scaled_qk_rows_checked_default_stride_nopartial_commit_only_preflight_only_required_bytes_parity_commit_only=ok"
    )
