#!/usr/bin/env python3
"""Reference checks for GQAAttentionApplySoftmaxQ16CheckedNoPartialPreflightDefaultStrideCommitOnlyPreflightOnlyParityCommitOnlyPreflightOnlyParity (IQ-1437)."""
...
def gqa_attention_apply_softmax_q16_checked_nopartial_preflight_default_stride_commit_only_preflight_only_parity_commit_only_preflight_only_parity(
    scores_q32,
    scores_capacity: int,
    query_rows: int,
    key_rows: int,
    ...
    staged_commit_out = [recomputed_required_out_cells]
...
def test_random_vectors_keep_output_and_required_slots_immutable() -> None:
    rng = random.Random(20260425_1437)
