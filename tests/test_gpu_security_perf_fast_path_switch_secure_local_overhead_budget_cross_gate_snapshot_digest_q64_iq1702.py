#!/usr/bin/env python3
"""Harness for IQ-1702 snapshot-digest strict preflight parity gate."""
...
def fast_path_switch_secure_local_overhead_budget_cross_gate_snapshot_digest_q64_checked_commit_only_preflight_only_parity_commit_only_preflight_only_parity_iq1702(
...
def test_source_contains_iq1702_symbols() -> None:
    ...
    assert "// IQ-1702 strict diagnostics parity gate:" in src


def test_gate_missing_vector() -> None:
    status, out_values = (
        fast_path_switch_secure_local_overhead_budget_cross_gate_snapshot_digest_q64_checked_commit_only_preflight_only_parity_commit_only_preflight_only_parity_iq1702(
...
if __name__ == "__main__":
    test_source_contains_iq1702_symbols()
