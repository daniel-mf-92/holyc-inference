#!/usr/bin/env python3
"""Harness for IQ-1667 commit-only hardening wrapper over IQ-1666 strict parity + IQ-1661 preflight-only."""
...
def secure_local_budget_gate_iq1663(
    rows: list[RowOutput],
    rows_capacity: int,
    secure_local_mode: int,
    iommu_active: int,
...
def secure_local_budget_gate_iq1662(
    rows: list[RowOutput],
    rows_capacity: int,
    secure_local_mode: int,
    iommu_active: int,
    ...
    *,
    ...
    status_preflight_only, _, staged_tuple = _secure_local_budget_gate_commit_only_preflight_only(
        ...
        max_p95_overhead_q16,
        caller_outputs,
        force_commit_only_status_domain_drift=force_commit_status_domain_drift,
    )

    status_commit_only, canonical_tuple = _secure_local_budget_gate_commit_only(
        rows,
        rows_capacity,
        secure_local_mode,
        iommu_active,
    ...
    if status_preflight_only != status_commit_only or staged_tuple != canonical_tuple:
        return GPU_SEC_PERF_ERR_BAD_PARAM, caller_outputs

    return status_preflight_only, caller_outputs


def secure_local_budget_gate_iq1666(
    rows: list[RowOutput],
    rows_capacity: int,
    secure_local_mode: int,
    iommu_active: int,
    ...
    *,
    ...
    status_commit_only, staged_tuple = secure_local_budget_gate_iq1663(
        rows,
        rows_capacity,
        secure_local_mode,
        iommu_active,
    ...
    status_canonical, canonical_tuple = secure_local_budget_gate_iq1662(
        rows,
        rows_capacity,
        secure_local_mode,
        iommu_active,
...
def secure_local_budget_gate_iq1667(
    rows: list[RowOutput],
    rows_capacity: int,
    secure_local_mode: int,
    iommu_active: int,
    ...
    *,
    ...
    status_parity, parity_tuple = secure_local_budget_gate_iq1666(
        rows,
        rows_capacity,
        secure_local_mode,
        iommu_active,
        ...
        (0, 0, GPU_SEC_PERF_BUDGET_GATE_STATUS_POLICY_BLOCK),
        force_commit_status_domain_drift=force_parity_status_domain_drift,
        force_commit_tuple_drift=force_parity_tuple_drift,
    )
...
def test_source_contains_iq1667_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert "I32 GPUSecurityPerfMatrixRowOutputsSnapshotDigestQ64(" in src
    assert "I32 (" in src
    assert "status_parity = (" in src
    assert "status_preflight_only = (" in src
    assert "status_commit_only = (" in src
    assert "status_snapshot_digest = GPUSecurityPerfMatrixRowOutputsSnapshotDigestQ64(" in src
    assert "// IQ-1667 commit-only hardening wrapper over IQ-1666 strict diagnostics parity + IQ-1661 preflight-only:" in src
...
def test_gate_missing_and_threshold_breach_vectors() -> None:
    ...
    status, outputs = secure_local_budget_gate_iq1667(
        rows_gate_missing,
        rows_capacity=3,
...
if __name__ == "__main__":
    test_source_contains_iq1667_symbols()
