#!/usr/bin/env python3
"""Reference checks for GGUFMetadataReadF32BitsPairChecked semantics."""
...
def test_null_ptr_and_no_partial_write() -> None:
    ...
    assert (
        gguf_metadata_read_f32bits_pair_checked(
            None,
            16,
            cursor,
            16,
...
def test_success_reads_two_f32_raw_bit_patterns_and_advances() -> None:
...
def test_randomized_parity() -> None:
    rng = random.Random(20260417_230)
...
if __name__ == "__main__":
    ...
    test_success_reads_two_f32_raw_bit_patterns_and_advances()
