...
def test_known_vector_and_no_publish_on_failure() -> None:
    ...
    rng = random.Random(20260421_8551)
...
def test_null_output_ptr_rejected() -> None:
    rng = random.Random(20260421_8552)
...
def test_fuzz_parity_matches_explicit_checked_composition() -> None:
    ...
    for i in range(2600):
        ...
        rng = random.Random(20260421_1855000 + i)
        ...
        err_a = q4_0_q8_0_matmul_q32_tiled_avx2_bench_rows_preflight_only_commit_only_parity_preflight_only_commit_only_parity(
            lhs,
            lhs_capacity,
            row_count,
            lhs_stride,
