#!/usr/bin/env python3
"""Commit-only diagnostics harness for ...PreflightOnlyParityCommitOnlyPreflightOnlyParityCommitOnly (IQ-1082)."""
...
def tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_preflight_only_parity_commit_only_preflight_only_parity_commit_only(
    data: list[int] | None,
    byte_len: int,
