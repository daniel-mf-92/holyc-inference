#!/usr/bin/env python3
"""Parity harness for ...PreflightOnlyDefaultCapacityCommitOnlyParityNoAllocHardened."""
...
from test_tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes_preflight_only_default_capacity_commit_only_parity import (
    tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes_preflight_only_default_capacity_commit_only_parity,
)


def tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes_preflight_only_default_capacity_commit_only_parity_noalloc_hardened(
    data: list[int] | None,
    byte_len: int,
...
def test_source_contains_signature_and_hardening_calls() -> None:
    ...
    sig = "I32 TokenizerBPEEncodePromptCheckedNoAllocFromLensCommitOnlyRequiredBytesPreflightOnlyDefaultCapacityCommitOnlyParityNoAllocHardened("
    ...
    assert "TokenizerBPEEncodePromptCheckedNoAllocFromLensCommitOnlyRequiredBytesPreflightOnlyDefaultCapacityCommitOnlyParity(" in body
...
def test_success_error_no_write_parity_and_sentinel_preservation() -> None:
    ...
    err_a = tokenizer_bpe_encode_prompt_checked_noalloc_from_lens_commit_only_required_bytes_preflight_only_default_capacity_commit_only_parity_noalloc_hardened(
        payload,
        len(payload),
        cur_a,
        good_prompt_nbytes,
