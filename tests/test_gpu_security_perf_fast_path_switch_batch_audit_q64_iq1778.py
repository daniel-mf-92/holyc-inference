#!/usr/bin/env python3
"""Harness for IQ-1778 batch-audit zero-write diagnostics companion."""
...
import test_gpu_security_perf_fast_path_switch_batch_audit_q64_iq1777 as iq1777
...
HC_FN_IQ1778 = ""
HC_FN_COMPANION = iq1775.HC_FN_IQ1775
HC_FN_CANONICAL = iq1777.HC_FN_IQ1777
...
def iq1778_model(
    ...
    *,
    ...
    status_canonical, canonical_tuple = iq1777.iq1777_model(
        scenarios=scenarios,
        secure_local_mode=secure_local_mode,
        iommu_active=iommu_active,
        book_of_truth_gpu_hooks=book_of_truth_gpu_hooks,
...
def test_source_contains_iq1778_symbols() -> None:
    src = Path("src/gpu/security_perf_matrix.HC").read_text(encoding="utf-8")
    assert f"I32 {HC_FN_IQ1778}(" in src
    ...
    assert "// IQ-1778 zero-write diagnostics companion:" in src


def test_gate_missing_vector() -> None:
    saved_out = (4201, 4202, 4203, 4204)
    status, out_values = iq1778_model(
...
if __name__ == "__main__":
    test_source_contains_iq1778_symbols()
