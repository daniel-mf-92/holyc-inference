#!/usr/bin/env python3
"""Parity harness for KVCacheQ16ZeroTokenSpan...RequiredBytesCommitOnlyPreflightOnly (IQ-901)."""
...
def kv_cache_q16_zero_token_span_checked_nopartial_commit_only_preflight_only_required_bytes_commit_only_parity(
...
def test_source_contains_required_bytes_commit_only_preflight_only_helper() -> None:
    ...
    sig = "I32 KVCacheQ16ZeroTokenSpanCheckedNoPartialCommitOnlyPreflightOnlyRequiredBytesCommitOnlyParity("
...
def test_randomized_parity_vs_explicit_composition_adversarial() -> None:
    ...
    for _ in range(1000):
        ...
        err_a = kv_cache_q16_zero_token_span_checked_nopartial_commit_only_preflight_only_required_bytes_commit_only_parity(
            k_cache,
            k_cache_capacity,
            v_cache,
            v_cache_capacity,
