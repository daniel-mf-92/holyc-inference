#!/usr/bin/env python3
"""Commit-only parity gate checks for IQ-1329 telemetry digest wrapper."""
...
def telemetry_digest_q64_checked_nopartial_commit_only_preflight_only_parity_commit_only(
    ...
    *,
    ...
    if parity_digest != canonical_digest:
        return ERR_BAD_PARAM
...
def test_happy_path_publishes_once() -> None:
    out = [0x1234]
...
if __name__ == "__main__":
    test_happy_path_publishes_once()
