#!/usr/bin/env python3
"""Reference checks for GGUFMetadataReadF64BitsTripleChecked semantics."""
...
def test_null_ptr_and_no_partial_write() -> None:
    ...
    assert (
        gguf_metadata_read_f64bits_triple_checked(
            None,
            32,
            cursor,
            32,
...
def test_third_scalar_fail_does_not_commit_outputs_or_cursor() -> None:
...
def test_randomized_parity() -> None:
    rng = random.Random(20260417_243)
...
def run() -> None:
    ...
    print("gguf_metadata_read_f64bits_triple_checked_reference_checks=ok")
