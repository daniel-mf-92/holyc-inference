#!/usr/bin/env python3
"""Parity harness for ...NoAllocHardenedCommitOnlyPreflightOnlyParity (IQ-796)."""
...
def test_source_contains_commit_only_preflight_only_parity() -> None:
...
def test_commit_only_preflight_only_parity_overflow_propagation() -> None:
...
def test_commit_only_preflight_only_parity_matches_explicit_staged_composition_randomized() -> None:
    rng = random.Random(20260420_796)
    ...
    for _ in range(1000):
        ...
        err_a = attention_q16_apply_score_scale_rows_checked_nopartial_preflight_only_default_stride_required_stage_bytes_default_capacity_noalloc_hardened_commit_only_preflight_only_parity(
            in_scores,
            in_scores_capacity,
            row_count,
            token_count,
...
if __name__ == "__main__":
    ...
    print(
        ...
        "commit_only_preflight_only_parity=ok"
    )
